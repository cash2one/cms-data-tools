...
class AxnTaiwanSpider(scrapy.Spider):
    name = "axn-taiwan"
    allowed_domains = ["axn-taiwan.com"]
    start_urls = (
        'http://www.axn-taiwan.com/schedule/',
    )
    channelname = 'AXN Taiwan'
    issort = True
    ...
    def parse(self, response):
        ...
        for d in date:
            url = 'http://www.axn-taiwan.com/schedule/ajax/tw/data/listings/' + d
