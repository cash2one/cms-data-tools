...
class SonychannelasiaSpider(scrapy.Spider):
    name = "sonychannelasia"
    allowed_domains = ["sonychannelasia.com"]
    start_urls = (
        'http://www.sonychannelasia.com/schedule/',
    )
    channelname = 'Sony Channel Asia HD'
    issort = True
    ...
    def parse(self, response):
        ...
        for d in date:
            url = 'http://www.sonychannelasia.com/schedule/ajax/shk/data/listings/' + d
